...
import { Mic, X, Zap, Loader2, Volume2 } from 'lucide-react';
...
Você controla TODO o sistema por voz. Suas 10 capacidades são:
                        ...
                        for (const fc of message.toolCall.functionCalls) {
                            ...
                            try {
                                ...
                                // ─── navigate_to_page ───
                                    ...
                                    const route = args.page === 'dashboard' ? '/' : `/${args.page}`;
                                    navigate(route);
                                    ...
                                    if (!allTasks || allTasks.length === 0) {
                                        ...
                                        const match = allTasks.find(t => t.title.toLowerCase().includes(searchTerm))
                                          ...
                                          || allTasks.reduce((best, t) => {
                                              ...
                                              const bestScore = words.filter(w => best.title.toLowerCase().includes(w)).length;
